...
const API_URL = "http://localhost/Mi-codigo/Tienda/Backend/modelo/api_productos.php?seccion=productos.php"; // Cambia esta URL según corresponda
...
function agregarProducto(nombre, descripcion, precio) {
  fetch(API_URL, {
    ...
    .then(res => res.json()) // Convierte la respuesta a JSON
    .then(listarProductos()) // Muestra el resultado en consola
